...
/**
 * See {@code monaco.d.ts:3020:47}<br>
 * Original signature:<br>
 * {@code export interface IEditorConstructionOptions extends IEditorOptions  }<br>
 */
@SuppressWarnings("unused")
public class IEditorConstructionOptions extends IEditorOptions {

	public IEditorConstructionOptions(@Nonnull JsContext context, @Nonnull Object receiver) { super(context, receiver); }

 
	public IEditorConstructionOptions(@Nonnull JsContext context) { super(context); }
	 ...
	 * {@code acceptSuggestionOnCommitCharacter?: boolean; }<br>
	 */
	public IEditorConstructionOptions acceptSuggestionOnCommitCharacter(@Nonnull Boolean value) {
	 ...
	 * {@code accessibilityPageSize?: number; }<br>
	 */
	public IEditorConstructionOptions accessibilityPageSize(@Nonnull Double value) {
	 ...
	 * {@code ariaLabel?: string; }<br>
	 */
	public IEditorConstructionOptions ariaLabel(@Nonnull String value) {
		set("ariaLabel", value);
		return this;
	}
	 ...
	 * {@code automaticLayout?: boolean; }<br>
	 */
	public IEditorConstructionOptions automaticLayout(@Nonnull Boolean value) {
	 ...
	 * {@code codeActionsOnSaveTimeout?: number; }<br>
	 */
	public IEditorConstructionOptions codeActionsOnSaveTimeout(@Nonnull Double value) {
	 ...
	 * {@code codeLens?: boolean; }<br>
	 */
	public IEditorConstructionOptions codeLens(@Nonnull Boolean value) {
		set("codeLens", value);
		return this;
	}
	 ...
	 * {@code colorDecorators?: boolean; }<br>
	 */
	public IEditorConstructionOptions colorDecorators(@Nonnull Boolean value) {
	 ...
	 * {@code comments?: IEditorCommentsOptions; }<br>
	 */
	public IEditorConstructionOptions comments(@Nonnull IEditorCommentsOptions value) {
		set("comments", value);
		return this;
	}
	 ...
	 * {@code contextmenu?: boolean; }<br>
	 */
	public IEditorConstructionOptions contextmenu(@Nonnull Boolean value) {
	 ...
	 * {@code copyWithSyntaxHighlighting?: boolean; }<br>
	 */
	public IEditorConstructionOptions copyWithSyntaxHighlighting(@Nonnull Boolean value) {
	 ...
	 * {@code cursorSmoothCaretAnimation?: boolean; }<br>
	 */
	public IEditorConstructionOptions cursorSmoothCaretAnimation(@Nonnull Boolean value) {
	 ...
	 * {@code cursorSurroundingLines?: number; }<br>
	 */
	public IEditorConstructionOptions cursorSurroundingLines(@Nonnull Double value) {
	 ...
	 * {@code cursorWidth?: number; }<br>
	 */
	public IEditorConstructionOptions cursorWidth(@Nonnull Double value) {
	 ...
	 * {@code dimension?: IDimension; }<br>
	 */
	public IEditorConstructionOptions dimension(@Nonnull IDimension value) {
		set("dimension", value);
		return this;
	}
	 ...
	 * {@code disableLayerHinting?: boolean; }<br>
	 */
	public IEditorConstructionOptions disableLayerHinting(@Nonnull Boolean value) {
	 ...
	 * {@code disableMonospaceOptimizations?: boolean; }<br>
	 */
	public IEditorConstructionOptions disableMonospaceOptimizations(@Nonnull Boolean value) {
	 ...
	 * {@code dragAndDrop?: boolean; }<br>
	 */
	public IEditorConstructionOptions dragAndDrop(@Nonnull Boolean value) {
	 ...
	 * {@code emptySelectionClipboard?: boolean; }<br>
	 */
	public IEditorConstructionOptions emptySelectionClipboard(@Nonnull Boolean value) {
	 ...
	 * {@code extraEditorClassName?: string; }<br>
	 */
	public IEditorConstructionOptions extraEditorClassName(@Nonnull String value) {
	 ...
	 * {@code fastScrollSensitivity?: number; }<br>
	 */
	public IEditorConstructionOptions fastScrollSensitivity(@Nonnull Double value) {
	 ...
	 * {@code find?: IEditorFindOptions; }<br>
	 */
	public IEditorConstructionOptions find(@Nonnull IEditorFindOptions value) {
		set("find", value);
		return this;
	}
	 ...
	 * {@code fixedOverflowWidgets?: boolean; }<br>
	 */
	public IEditorConstructionOptions fixedOverflowWidgets(@Nonnull Boolean value) {
	 ...
	 * {@code folding?: boolean; }<br>
	 */
	public IEditorConstructionOptions folding(@Nonnull Boolean value) {
		set("folding", value);
		return this;
	}
	 ...
	 * {@code foldingHighlight?: boolean; }<br>
	 */
	public IEditorConstructionOptions foldingHighlight(@Nonnull Boolean value) {
	 ...
	 * {@code fontFamily?: string; }<br>
	 */
	public IEditorConstructionOptions fontFamily(@Nonnull String value) {
	 ...
	 * {@code fontLigatures?: boolean | string; }<br>
	 */
	public IEditorConstructionOptions fontLigatures(@Nonnull Boolean value) {
	 ...
	 * {@code fontLigatures?: boolean | string; }<br>
	 */
	public IEditorConstructionOptions fontLigatures(@Nonnull String value) {
		set("fontLigatures", value);
		return this;
	}
	 ...
	 * {@code fontSize?: number; }<br>
	 */
	public IEditorConstructionOptions fontSize(@Nonnull Double value) {
		set("fontSize", value);
		return this;
	}
	 ...
	 * {@code fontWeight?: string; }<br>
	 */
	public IEditorConstructionOptions fontWeight(@Nonnull String value) {
	 ...
	 * {@code formatOnPaste?: boolean; }<br>
	 */
	public IEditorConstructionOptions formatOnPaste(@Nonnull Boolean value) {
	 ...
	 * {@code formatOnType?: boolean; }<br>
	 */
	public IEditorConstructionOptions formatOnType(@Nonnull Boolean value) {
	 ...
	 * {@code glyphMargin?: boolean; }<br>
	 */
	public IEditorConstructionOptions glyphMargin(@Nonnull Boolean value) {
	 ...
	 * {@code gotoLocation?: IGotoLocationOptions; }<br>
	 */
	public IEditorConstructionOptions gotoLocation(@Nonnull IGotoLocationOptions value) {
	 ...
	 * {@code hideCursorInOverviewRuler?: boolean; }<br>
	 */
	public IEditorConstructionOptions hideCursorInOverviewRuler(@Nonnull Boolean value) {
	 ...
	 * {@code highlightActiveIndentGuide?: boolean; }<br>
	 */
	public IEditorConstructionOptions highlightActiveIndentGuide(@Nonnull Boolean value) {
	 ...
	 * {@code hover?: IEditorHoverOptions; }<br>
	 */
	public IEditorConstructionOptions hover(@Nonnull IEditorHoverOptions value) {
		set("hover", value);
		return this;
	}
	 ...
	 * {@code inDiffEditor?: boolean; }<br>
	 */
	public IEditorConstructionOptions inDiffEditor(@Nonnull Boolean value) {
	 ...
	 * {@code letterSpacing?: number; }<br>
	 */
	public IEditorConstructionOptions letterSpacing(@Nonnull Double value) {
	 ...
	 * {@code lightbulb?: IEditorLightbulbOptions; }<br>
	 */
	public IEditorConstructionOptions lightbulb(@Nonnull IEditorLightbulbOptions value) {
		set("lightbulb", value);
		return this;
	}
	 ...
	 * {@code lineDecorationsWidth?: number | string; }<br>
	 */
	public IEditorConstructionOptions lineDecorationsWidth(@Nonnull Double value) {
	 ...
	 * {@code lineDecorationsWidth?: number | string; }<br>
	 */
	public IEditorConstructionOptions lineDecorationsWidth(@Nonnull String value) {
		set("lineDecorationsWidth", value);
		return this;
	}
	 ...
	 * {@code lineHeight?: number; }<br>
	 */
	public IEditorConstructionOptions lineHeight(@Nonnull Double value) {
	 ...
	 * {@code lineNumbersMinChars?: number; }<br>
	 */
	public IEditorConstructionOptions lineNumbersMinChars(@Nonnull Double value) {
	 ...
	 * {@code links?: boolean; }<br>
	 */
	public IEditorConstructionOptions links(@Nonnull Boolean value) {
		set("links", value);
		return this;
	}
	 ...
	 * {@code minimap?: IEditorMinimapOptions; }<br>
	 */
	public IEditorConstructionOptions minimap(@Nonnull IEditorMinimapOptions value) {
		set("minimap", value);
		return this;
	}
	 ...
	 * {@code mouseWheelScrollSensitivity?: number; }<br>
	 */
	public IEditorConstructionOptions mouseWheelScrollSensitivity(@Nonnull Double value) {
	 ...
	 * {@code mouseWheelZoom?: boolean; }<br>
	 */
	public IEditorConstructionOptions mouseWheelZoom(@Nonnull Boolean value) {
	 ...
	 * {@code multiCursorMergeOverlapping?: boolean; }<br>
	 */
	public IEditorConstructionOptions multiCursorMergeOverlapping(@Nonnull Boolean value) {
	 ...
	 * {@code occurrencesHighlight?: boolean; }<br>
	 */
	public IEditorConstructionOptions occurrencesHighlight(@Nonnull Boolean value) {
	 ...
	 * {@code overviewRulerBorder?: boolean; }<br>
	 */
	public IEditorConstructionOptions overviewRulerBorder(@Nonnull Boolean value) {
	 ...
	 * {@code overviewRulerLanes?: number; }<br>
	 */
	public IEditorConstructionOptions overviewRulerLanes(@Nonnull Double value) {
	 ...
	 * {@code parameterHints?: IEditorParameterHintOptions; }<br>
	 */
	public IEditorConstructionOptions parameterHints(@Nonnull IEditorParameterHintOptions value) {
	 ...
	 * {@code quickSuggestions?: boolean | IQuickSuggestionsOptions; }<br>
	 */
	public IEditorConstructionOptions quickSuggestions(@Nonnull Boolean value) {
	 ...
	 * {@code quickSuggestions?: boolean | IQuickSuggestionsOptions; }<br>
	 */
	public IEditorConstructionOptions quickSuggestions(@Nonnull IQuickSuggestionsOptions value) {
		set("quickSuggestions", value);
		return this;
	}
	 ...
	 * {@code quickSuggestionsDelay?: number; }<br>
	 */
	public IEditorConstructionOptions quickSuggestionsDelay(@Nonnull Double value) {
	 ...
	 * {@code readOnly?: boolean; }<br>
	 */
	public IEditorConstructionOptions readOnly(@Nonnull Boolean value) {
		set("readOnly", value);
		return this;
	}
	 ...
	 * {@code renderControlCharacters?: boolean; }<br>
	 */
	public IEditorConstructionOptions renderControlCharacters(@Nonnull Boolean value) {
	 ...
	 * {@code renderFinalNewline?: boolean; }<br>
	 */
	public IEditorConstructionOptions renderFinalNewline(@Nonnull Boolean value) {
	 ...
	 * {@code renderIndentGuides?: boolean; }<br>
	 */
	public IEditorConstructionOptions renderIndentGuides(@Nonnull Boolean value) {
	 ...
	 * {@code revealHorizontalRightPadding?: number; }<br>
	 */
	public IEditorConstructionOptions revealHorizontalRightPadding(@Nonnull Double value) {
	 ...
	 * {@code roundedSelection?: boolean; }<br>
	 */
	public IEditorConstructionOptions roundedSelection(@Nonnull Boolean value) {
	 ...
	 * {@code rulers?: number[]; }<br>
	 */
	public IEditorConstructionOptions rulers(@Nonnull List<Double> value) {
	 ...
	 * {@code scrollBeyondLastColumn?: number; }<br>
	 */
	public IEditorConstructionOptions scrollBeyondLastColumn(@Nonnull Double value) {
	 ...
	 * {@code scrollBeyondLastLine?: boolean; }<br>
	 */
	public IEditorConstructionOptions scrollBeyondLastLine(@Nonnull Boolean value) {
	 ...
	 * {@code scrollbar?: IEditorScrollbarOptions; }<br>
	 */
	public IEditorConstructionOptions scrollbar(@Nonnull IEditorScrollbarOptions value) {
		set("scrollbar", value);
		return this;
	}
	 ...
	 * {@code selectOnLineNumbers?: boolean; }<br>
	 */
	public IEditorConstructionOptions selectOnLineNumbers(@Nonnull Boolean value) {
	 ...
	 * {@code selectionClipboard?: boolean; }<br>
	 */
	public IEditorConstructionOptions selectionClipboard(@Nonnull Boolean value) {
	 ...
	 * {@code selectionHighlight?: boolean; }<br>
	 */
	public IEditorConstructionOptions selectionHighlight(@Nonnull Boolean value) {
	 ...
	 * {@code showUnused?: boolean; }<br>
	 */
	public IEditorConstructionOptions showUnused(@Nonnull Boolean value) {
	 ...
	 * {@code smoothScrolling?: boolean; }<br>
	 */
	public IEditorConstructionOptions smoothScrolling(@Nonnull Boolean value) {
	 ...
	 * {@code stopRenderingLineAfter?: number; }<br>
	 */
	public IEditorConstructionOptions stopRenderingLineAfter(@Nonnull Double value) {
	 ...
	 * {@code suggest?: ISuggestOptions; }<br>
	 */
	public IEditorConstructionOptions suggest(@Nonnull ISuggestOptions value) {
		set("suggest", value);
		return this;
	}
	 ...
	 * {@code suggestFontSize?: number; }<br>
	 */
	public IEditorConstructionOptions suggestFontSize(@Nonnull Double value) {
	 ...
	 * {@code suggestLineHeight?: number; }<br>
	 */
	public IEditorConstructionOptions suggestLineHeight(@Nonnull Double value) {
	 ...
	 * {@code suggestOnTriggerCharacters?: boolean; }<br>
	 */
	public IEditorConstructionOptions suggestOnTriggerCharacters(@Nonnull Boolean value) {
	 ...
	 * {@code useTabStops?: boolean; }<br>
	 */
	public IEditorConstructionOptions useTabStops(@Nonnull Boolean value) {
	 ...
	 * {@code wordSeparators?: string; }<br>
	 */
	public IEditorConstructionOptions wordSeparators(@Nonnull String value) {
	 ...
	 * {@code wordWrapBreakAfterCharacters?: string; }<br>
	 */
	public IEditorConstructionOptions wordWrapBreakAfterCharacters(@Nonnull String value) {
	 ...
	 * {@code wordWrapBreakBeforeCharacters?: string; }<br>
	 */
	public IEditorConstructionOptions wordWrapBreakBeforeCharacters(@Nonnull String value) {
	 ...
	 * {@code wordWrapColumn?: number; }<br>
	 */
	public IEditorConstructionOptions wordWrapColumn(@Nonnull Double value) {
	 ...
	 * {@code wordWrapMinified?: boolean; }<br>
	 */
	public IEditorConstructionOptions wordWrapMinified(@Nonnull Boolean value) {
