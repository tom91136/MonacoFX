...
/**
 * <p>The options to create a diff editor.</p>
 * See {@code monaco.d.ts:1148:51}<br>
 * Original signature:<br>
 * {@code export interface IDiffEditorConstructionOptions extends IDiffEditorOptions  }<br>
 */
@SuppressWarnings("unused")
public class IDiffEditorConstructionOptions extends IDiffEditorOptions {

	public IDiffEditorConstructionOptions(@Nonnull JsContext context, @Nonnull Object receiver) { super(context, receiver); }

 
	public IDiffEditorConstructionOptions(@Nonnull JsContext context) { super(context); }
	 ...
	 * {@code acceptSuggestionOnCommitCharacter?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions acceptSuggestionOnCommitCharacter(@Nonnull Boolean value) {
	 ...
	 * {@code accessibilityPageSize?: number; }<br>
	 */
	public IDiffEditorConstructionOptions accessibilityPageSize(@Nonnull Double value) {
	 ...
	 * {@code ariaLabel?: string; }<br>
	 */
	public IDiffEditorConstructionOptions ariaLabel(@Nonnull String value) {
		set("ariaLabel", value);
		return this;
	}
	 ...
	 * {@code automaticLayout?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions automaticLayout(@Nonnull Boolean value) {
	 ...
	 * {@code codeActionsOnSaveTimeout?: number; }<br>
	 */
	public IDiffEditorConstructionOptions codeActionsOnSaveTimeout(@Nonnull Double value) {
	 ...
	 * {@code codeLens?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions codeLens(@Nonnull Boolean value) {
		set("codeLens", value);
		return this;
	}
	 ...
	 * {@code colorDecorators?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions colorDecorators(@Nonnull Boolean value) {
	 ...
	 * {@code comments?: IEditorCommentsOptions; }<br>
	 */
	public IDiffEditorConstructionOptions comments(@Nonnull IEditorCommentsOptions value) {
		set("comments", value);
		return this;
	}
	 ...
	 * {@code contextmenu?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions contextmenu(@Nonnull Boolean value) {
	 ...
	 * {@code copyWithSyntaxHighlighting?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions copyWithSyntaxHighlighting(@Nonnull Boolean value) {
	 ...
	 * {@code cursorSmoothCaretAnimation?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions cursorSmoothCaretAnimation(@Nonnull Boolean value) {
	 ...
	 * {@code cursorSurroundingLines?: number; }<br>
	 */
	public IDiffEditorConstructionOptions cursorSurroundingLines(@Nonnull Double value) {
	 ...
	 * {@code cursorWidth?: number; }<br>
	 */
	public IDiffEditorConstructionOptions cursorWidth(@Nonnull Double value) {
	 ...
	 * {@code disableLayerHinting?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions disableLayerHinting(@Nonnull Boolean value) {
	 ...
	 * {@code disableMonospaceOptimizations?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions disableMonospaceOptimizations(@Nonnull Boolean value) {
	 ...
	 * {@code dragAndDrop?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions dragAndDrop(@Nonnull Boolean value) {
	 ...
	 * {@code emptySelectionClipboard?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions emptySelectionClipboard(@Nonnull Boolean value) {
	 ...
	 * {@code enableSplitViewResizing?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions enableSplitViewResizing(@Nonnull Boolean value) {
	 ...
	 * {@code extraEditorClassName?: string; }<br>
	 */
	public IDiffEditorConstructionOptions extraEditorClassName(@Nonnull String value) {
	 ...
	 * {@code fastScrollSensitivity?: number; }<br>
	 */
	public IDiffEditorConstructionOptions fastScrollSensitivity(@Nonnull Double value) {
	 ...
	 * {@code find?: IEditorFindOptions; }<br>
	 */
	public IDiffEditorConstructionOptions find(@Nonnull IEditorFindOptions value) {
		set("find", value);
		return this;
	}
	 ...
	 * {@code fixedOverflowWidgets?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions fixedOverflowWidgets(@Nonnull Boolean value) {
	 ...
	 * {@code folding?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions folding(@Nonnull Boolean value) {
		set("folding", value);
		return this;
	}
	 ...
	 * {@code foldingHighlight?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions foldingHighlight(@Nonnull Boolean value) {
	 ...
	 * {@code fontFamily?: string; }<br>
	 */
	public IDiffEditorConstructionOptions fontFamily(@Nonnull String value) {
	 ...
	 * {@code fontLigatures?: boolean | string; }<br>
	 */
	public IDiffEditorConstructionOptions fontLigatures(@Nonnull Boolean value) {
	 ...
	 * {@code fontLigatures?: boolean | string; }<br>
	 */
	public IDiffEditorConstructionOptions fontLigatures(@Nonnull String value) {
		set("fontLigatures", value);
		return this;
	}
	 ...
	 * {@code fontSize?: number; }<br>
	 */
	public IDiffEditorConstructionOptions fontSize(@Nonnull Double value) {
		set("fontSize", value);
		return this;
	}
	 ...
	 * {@code fontWeight?: string; }<br>
	 */
	public IDiffEditorConstructionOptions fontWeight(@Nonnull String value) {
	 ...
	 * {@code formatOnPaste?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions formatOnPaste(@Nonnull Boolean value) {
	 ...
	 * {@code formatOnType?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions formatOnType(@Nonnull Boolean value) {
	 ...
	 * {@code glyphMargin?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions glyphMargin(@Nonnull Boolean value) {
	 ...
	 * {@code gotoLocation?: IGotoLocationOptions; }<br>
	 */
	public IDiffEditorConstructionOptions gotoLocation(@Nonnull IGotoLocationOptions value) {
	 ...
	 * {@code hideCursorInOverviewRuler?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions hideCursorInOverviewRuler(@Nonnull Boolean value) {
	 ...
	 * {@code highlightActiveIndentGuide?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions highlightActiveIndentGuide(@Nonnull Boolean value) {
	 ...
	 * {@code hover?: IEditorHoverOptions; }<br>
	 */
	public IDiffEditorConstructionOptions hover(@Nonnull IEditorHoverOptions value) {
		set("hover", value);
		return this;
	}
	 ...
	 * {@code ignoreTrimWhitespace?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions ignoreTrimWhitespace(@Nonnull Boolean value) {
	 ...
	 * {@code inDiffEditor?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions inDiffEditor(@Nonnull Boolean value) {
	 ...
	 * {@code letterSpacing?: number; }<br>
	 */
	public IDiffEditorConstructionOptions letterSpacing(@Nonnull Double value) {
	 ...
	 * {@code lightbulb?: IEditorLightbulbOptions; }<br>
	 */
	public IDiffEditorConstructionOptions lightbulb(@Nonnull IEditorLightbulbOptions value) {
		set("lightbulb", value);
		return this;
	}
	 ...
	 * {@code lineDecorationsWidth?: number | string; }<br>
	 */
	public IDiffEditorConstructionOptions lineDecorationsWidth(@Nonnull Double value) {
	 ...
	 * {@code lineDecorationsWidth?: number | string; }<br>
	 */
	public IDiffEditorConstructionOptions lineDecorationsWidth(@Nonnull String value) {
		set("lineDecorationsWidth", value);
		return this;
	}
	 ...
	 * {@code lineHeight?: number; }<br>
	 */
	public IDiffEditorConstructionOptions lineHeight(@Nonnull Double value) {
	 ...
	 * {@code lineNumbersMinChars?: number; }<br>
	 */
	public IDiffEditorConstructionOptions lineNumbersMinChars(@Nonnull Double value) {
	 ...
	 * {@code links?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions links(@Nonnull Boolean value) {
		set("links", value);
		return this;
	}
	 ...
	 * {@code maxComputationTime?: number; }<br>
	 */
	public IDiffEditorConstructionOptions maxComputationTime(@Nonnull Double value) {
	 ...
	 * {@code minimap?: IEditorMinimapOptions; }<br>
	 */
	public IDiffEditorConstructionOptions minimap(@Nonnull IEditorMinimapOptions value) {
		set("minimap", value);
		return this;
	}
	 ...
	 * {@code mouseWheelScrollSensitivity?: number; }<br>
	 */
	public IDiffEditorConstructionOptions mouseWheelScrollSensitivity(@Nonnull Double value) {
	 ...
	 * {@code mouseWheelZoom?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions mouseWheelZoom(@Nonnull Boolean value) {
	 ...
	 * {@code multiCursorMergeOverlapping?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions multiCursorMergeOverlapping(@Nonnull Boolean value) {
	 ...
	 * {@code occurrencesHighlight?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions occurrencesHighlight(@Nonnull Boolean value) {
	 ...
	 * {@code originalEditable?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions originalEditable(@Nonnull Boolean value) {
	 ...
	 * {@code overviewRulerBorder?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions overviewRulerBorder(@Nonnull Boolean value) {
	 ...
	 * {@code overviewRulerLanes?: number; }<br>
	 */
	public IDiffEditorConstructionOptions overviewRulerLanes(@Nonnull Double value) {
	 ...
	 * {@code parameterHints?: IEditorParameterHintOptions; }<br>
	 */
	public IDiffEditorConstructionOptions parameterHints(@Nonnull IEditorParameterHintOptions value) {
	 ...
	 * {@code quickSuggestions?: boolean | IQuickSuggestionsOptions; }<br>
	 */
	public IDiffEditorConstructionOptions quickSuggestions(@Nonnull Boolean value) {
	 ...
	 * {@code quickSuggestions?: boolean | IQuickSuggestionsOptions; }<br>
	 */
	public IDiffEditorConstructionOptions quickSuggestions(@Nonnull IQuickSuggestionsOptions value) {
		set("quickSuggestions", value);
		return this;
	}
	 ...
	 * {@code quickSuggestionsDelay?: number; }<br>
	 */
	public IDiffEditorConstructionOptions quickSuggestionsDelay(@Nonnull Double value) {
	 ...
	 * {@code readOnly?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions readOnly(@Nonnull Boolean value) {
		set("readOnly", value);
		return this;
	}
	 ...
	 * {@code renderControlCharacters?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions renderControlCharacters(@Nonnull Boolean value) {
	 ...
	 * {@code renderFinalNewline?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions renderFinalNewline(@Nonnull Boolean value) {
	 ...
	 * {@code renderIndentGuides?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions renderIndentGuides(@Nonnull Boolean value) {
	 ...
	 * {@code renderIndicators?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions renderIndicators(@Nonnull Boolean value) {
	 ...
	 * {@code renderSideBySide?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions renderSideBySide(@Nonnull Boolean value) {
	 ...
	 * {@code revealHorizontalRightPadding?: number; }<br>
	 */
	public IDiffEditorConstructionOptions revealHorizontalRightPadding(@Nonnull Double value) {
	 ...
	 * {@code roundedSelection?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions roundedSelection(@Nonnull Boolean value) {
	 ...
	 * {@code rulers?: number[]; }<br>
	 */
	public IDiffEditorConstructionOptions rulers(@Nonnull List<Double> value) {
	 ...
	 * {@code scrollBeyondLastColumn?: number; }<br>
	 */
	public IDiffEditorConstructionOptions scrollBeyondLastColumn(@Nonnull Double value) {
	 ...
	 * {@code scrollBeyondLastLine?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions scrollBeyondLastLine(@Nonnull Boolean value) {
	 ...
	 * {@code scrollbar?: IEditorScrollbarOptions; }<br>
	 */
	public IDiffEditorConstructionOptions scrollbar(@Nonnull IEditorScrollbarOptions value) {
		set("scrollbar", value);
		return this;
	}
	 ...
	 * {@code selectOnLineNumbers?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions selectOnLineNumbers(@Nonnull Boolean value) {
	 ...
	 * {@code selectionClipboard?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions selectionClipboard(@Nonnull Boolean value) {
	 ...
	 * {@code selectionHighlight?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions selectionHighlight(@Nonnull Boolean value) {
	 ...
	 * {@code showUnused?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions showUnused(@Nonnull Boolean value) {
	 ...
	 * {@code smoothScrolling?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions smoothScrolling(@Nonnull Boolean value) {
	 ...
	 * {@code stopRenderingLineAfter?: number; }<br>
	 */
	public IDiffEditorConstructionOptions stopRenderingLineAfter(@Nonnull Double value) {
	 ...
	 * {@code suggest?: ISuggestOptions; }<br>
	 */
	public IDiffEditorConstructionOptions suggest(@Nonnull ISuggestOptions value) {
		set("suggest", value);
		return this;
	}
	 ...
	 * {@code suggestFontSize?: number; }<br>
	 */
	public IDiffEditorConstructionOptions suggestFontSize(@Nonnull Double value) {
	 ...
	 * {@code suggestLineHeight?: number; }<br>
	 */
	public IDiffEditorConstructionOptions suggestLineHeight(@Nonnull Double value) {
	 ...
	 * {@code suggestOnTriggerCharacters?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions suggestOnTriggerCharacters(@Nonnull Boolean value) {
	 ...
	 * See {@code monaco.d.ts:1155:13}<br>
	 * Original signature:<br>
	 ...
	 * {@code theme?: string; }<br>
	 */
	public IDiffEditorConstructionOptions theme(@Nonnull String value) {
		set("theme", value);
		return this;
	}
	 ...
	 * {@code useTabStops?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions useTabStops(@Nonnull Boolean value) {
	 ...
	 * {@code wordSeparators?: string; }<br>
	 */
	public IDiffEditorConstructionOptions wordSeparators(@Nonnull String value) {
	 ...
	 * {@code wordWrapBreakAfterCharacters?: string; }<br>
	 */
	public IDiffEditorConstructionOptions wordWrapBreakAfterCharacters(@Nonnull String value) {
	 ...
	 * {@code wordWrapBreakBeforeCharacters?: string; }<br>
	 */
	public IDiffEditorConstructionOptions wordWrapBreakBeforeCharacters(@Nonnull String value) {
	 ...
	 * {@code wordWrapColumn?: number; }<br>
	 */
	public IDiffEditorConstructionOptions wordWrapColumn(@Nonnull Double value) {
	 ...
	 * {@code wordWrapMinified?: boolean; }<br>
	 */
	public IDiffEditorConstructionOptions wordWrapMinified(@Nonnull Boolean value) {
