...
/**
 * <p>Configuration options for the editor.</p>
 * See {@code monaco.d.ts:2508:35}<br>
 * Original signature:<br>
 * {@code export interface IEditorOptions  }<br>
 */
@SuppressWarnings("unused")
public class IEditorOptions extends JsProxy {

	public IEditorOptions(@Nonnull JsContext context, @Nonnull Object receiver) { super(context, receiver); }

 
	public IEditorOptions(@Nonnull JsContext context) { super(context); }
	 ...
	 * {@code acceptSuggestionOnCommitCharacter?: boolean; }<br>
	 */
	public IEditorOptions acceptSuggestionOnCommitCharacter(@Nonnull Boolean value) {
	 ...
	 * {@code accessibilityPageSize?: number; }<br>
	 */
	public IEditorOptions accessibilityPageSize(@Nonnull Double value) {
	 ...
	 * {@code ariaLabel?: string; }<br>
	 */
	public IEditorOptions ariaLabel(@Nonnull String value) {
		set("ariaLabel", value);
		return this;
	}
	 ...
	 * {@code automaticLayout?: boolean; }<br>
	 */
	public IEditorOptions automaticLayout(@Nonnull Boolean value) {
	 ...
	 * {@code codeActionsOnSaveTimeout?: number; }<br>
	 */
	public IEditorOptions codeActionsOnSaveTimeout(@Nonnull Double value) {
	 ...
	 * {@code codeLens?: boolean; }<br>
	 */
	public IEditorOptions codeLens(@Nonnull Boolean value) {
		set("codeLens", value);
		return this;
	}
	 ...
	 * {@code colorDecorators?: boolean; }<br>
	 */
	public IEditorOptions colorDecorators(@Nonnull Boolean value) {
	 ...
	 * {@code comments?: IEditorCommentsOptions; }<br>
	 */
	public IEditorOptions comments(@Nonnull IEditorCommentsOptions value) {
		set("comments", value);
		return this;
	}
	 ...
	 * {@code contextmenu?: boolean; }<br>
	 */
	public IEditorOptions contextmenu(@Nonnull Boolean value) {
	 ...
	 * {@code copyWithSyntaxHighlighting?: boolean; }<br>
	 */
	public IEditorOptions copyWithSyntaxHighlighting(@Nonnull Boolean value) {
	 ...
	 * {@code cursorSmoothCaretAnimation?: boolean; }<br>
	 */
	public IEditorOptions cursorSmoothCaretAnimation(@Nonnull Boolean value) {
	 ...
	 * {@code cursorSurroundingLines?: number; }<br>
	 */
	public IEditorOptions cursorSurroundingLines(@Nonnull Double value) {
	 ...
	 * {@code cursorWidth?: number; }<br>
	 */
	public IEditorOptions cursorWidth(@Nonnull Double value) {
	 ...
	 * {@code disableLayerHinting?: boolean; }<br>
	 */
	public IEditorOptions disableLayerHinting(@Nonnull Boolean value) {
	 ...
	 * {@code disableMonospaceOptimizations?: boolean; }<br>
	 */
	public IEditorOptions disableMonospaceOptimizations(@Nonnull Boolean value) {
	 ...
	 * {@code dragAndDrop?: boolean; }<br>
	 */
	public IEditorOptions dragAndDrop(@Nonnull Boolean value) {
	 ...
	 * {@code emptySelectionClipboard?: boolean; }<br>
	 */
	public IEditorOptions emptySelectionClipboard(@Nonnull Boolean value) {
	 ...
	 * {@code extraEditorClassName?: string; }<br>
	 */
	public IEditorOptions extraEditorClassName(@Nonnull String value) {
	 ...
	 * {@code fastScrollSensitivity?: number; }<br>
	 */
	public IEditorOptions fastScrollSensitivity(@Nonnull Double value) {
	 ...
	 * {@code find?: IEditorFindOptions; }<br>
	 */
	public IEditorOptions find(@Nonnull IEditorFindOptions value) {
		set("find", value);
		return this;
	}
	 ...
	 * {@code fixedOverflowWidgets?: boolean; }<br>
	 */
	public IEditorOptions fixedOverflowWidgets(@Nonnull Boolean value) {
	 ...
	 * {@code folding?: boolean; }<br>
	 */
	public IEditorOptions folding(@Nonnull Boolean value) {
		set("folding", value);
		return this;
	}
	 ...
	 * {@code foldingHighlight?: boolean; }<br>
	 */
	public IEditorOptions foldingHighlight(@Nonnull Boolean value) {
	 ...
	 * {@code fontFamily?: string; }<br>
	 */
	public IEditorOptions fontFamily(@Nonnull String value) {
	 ...
	 * {@code fontLigatures?: boolean | string; }<br>
	 */
	public IEditorOptions fontLigatures(@Nonnull Boolean value) {
	 ...
	 * {@code fontLigatures?: boolean | string; }<br>
	 */
	public IEditorOptions fontLigatures(@Nonnull String value) {
		set("fontLigatures", value);
		return this;
	}
	 ...
	 * {@code fontSize?: number; }<br>
	 */
	public IEditorOptions fontSize(@Nonnull Double value) {
		set("fontSize", value);
		return this;
	}
	 ...
	 * {@code fontWeight?: string; }<br>
	 */
	public IEditorOptions fontWeight(@Nonnull String value) {
	 ...
	 * {@code formatOnPaste?: boolean; }<br>
	 */
	public IEditorOptions formatOnPaste(@Nonnull Boolean value) {
	 ...
	 * {@code formatOnType?: boolean; }<br>
	 */
	public IEditorOptions formatOnType(@Nonnull Boolean value) {
	 ...
	 * {@code glyphMargin?: boolean; }<br>
	 */
	public IEditorOptions glyphMargin(@Nonnull Boolean value) {
	 ...
	 * {@code gotoLocation?: IGotoLocationOptions; }<br>
	 */
	public IEditorOptions gotoLocation(@Nonnull IGotoLocationOptions value) {
	 ...
	 * {@code hideCursorInOverviewRuler?: boolean; }<br>
	 */
	public IEditorOptions hideCursorInOverviewRuler(@Nonnull Boolean value) {
	 ...
	 * {@code highlightActiveIndentGuide?: boolean; }<br>
	 */
	public IEditorOptions highlightActiveIndentGuide(@Nonnull Boolean value) {
	 ...
	 * {@code hover?: IEditorHoverOptions; }<br>
	 */
	public IEditorOptions hover(@Nonnull IEditorHoverOptions value) {
		set("hover", value);
		return this;
	}
	 ...
	 * {@code inDiffEditor?: boolean; }<br>
	 */
	public IEditorOptions inDiffEditor(@Nonnull Boolean value) {
	 ...
	 * {@code letterSpacing?: number; }<br>
	 */
	public IEditorOptions letterSpacing(@Nonnull Double value) {
	 ...
	 * {@code lightbulb?: IEditorLightbulbOptions; }<br>
	 */
	public IEditorOptions lightbulb(@Nonnull IEditorLightbulbOptions value) {
		set("lightbulb", value);
		return this;
	}
	 ...
	 * {@code lineDecorationsWidth?: number | string; }<br>
	 */
	public IEditorOptions lineDecorationsWidth(@Nonnull Double value) {
	 ...
	 * {@code lineDecorationsWidth?: number | string; }<br>
	 */
	public IEditorOptions lineDecorationsWidth(@Nonnull String value) {
		set("lineDecorationsWidth", value);
		return this;
	}
	 ...
	 * {@code lineHeight?: number; }<br>
	 */
	public IEditorOptions lineHeight(@Nonnull Double value) {
	 ...
	 * {@code lineNumbersMinChars?: number; }<br>
	 */
	public IEditorOptions lineNumbersMinChars(@Nonnull Double value) {
	 ...
	 * {@code links?: boolean; }<br>
	 */
	public IEditorOptions links(@Nonnull Boolean value) {
		set("links", value);
		return this;
	}
	 ...
	 * {@code minimap?: IEditorMinimapOptions; }<br>
	 */
	public IEditorOptions minimap(@Nonnull IEditorMinimapOptions value) {
		set("minimap", value);
		return this;
	}
	 ...
	 * {@code mouseWheelScrollSensitivity?: number; }<br>
	 */
	public IEditorOptions mouseWheelScrollSensitivity(@Nonnull Double value) {
	 ...
	 * {@code mouseWheelZoom?: boolean; }<br>
	 */
	public IEditorOptions mouseWheelZoom(@Nonnull Boolean value) {
	 ...
	 * {@code multiCursorMergeOverlapping?: boolean; }<br>
	 */
	public IEditorOptions multiCursorMergeOverlapping(@Nonnull Boolean value) {
	 ...
	 * {@code occurrencesHighlight?: boolean; }<br>
	 */
	public IEditorOptions occurrencesHighlight(@Nonnull Boolean value) {
	 ...
	 * {@code overviewRulerBorder?: boolean; }<br>
	 */
	public IEditorOptions overviewRulerBorder(@Nonnull Boolean value) {
	 ...
	 * {@code overviewRulerLanes?: number; }<br>
	 */
	public IEditorOptions overviewRulerLanes(@Nonnull Double value) {
	 ...
	 * {@code parameterHints?: IEditorParameterHintOptions; }<br>
	 */
	public IEditorOptions parameterHints(@Nonnull IEditorParameterHintOptions value) {
	 ...
	 * {@code quickSuggestions?: boolean | IQuickSuggestionsOptions; }<br>
	 */
	public IEditorOptions quickSuggestions(@Nonnull Boolean value) {
	 ...
	 * {@code quickSuggestions?: boolean | IQuickSuggestionsOptions; }<br>
	 */
	public IEditorOptions quickSuggestions(@Nonnull IQuickSuggestionsOptions value) {
		set("quickSuggestions", value);
		return this;
	}
	 ...
	 * {@code quickSuggestionsDelay?: number; }<br>
	 */
	public IEditorOptions quickSuggestionsDelay(@Nonnull Double value) {
	 ...
	 * {@code readOnly?: boolean; }<br>
	 */
	public IEditorOptions readOnly(@Nonnull Boolean value) {
		set("readOnly", value);
		return this;
	}
	 ...
	 * {@code renderControlCharacters?: boolean; }<br>
	 */
	public IEditorOptions renderControlCharacters(@Nonnull Boolean value) {
	 ...
	 * {@code renderFinalNewline?: boolean; }<br>
	 */
	public IEditorOptions renderFinalNewline(@Nonnull Boolean value) {
	 ...
	 * {@code renderIndentGuides?: boolean; }<br>
	 */
	public IEditorOptions renderIndentGuides(@Nonnull Boolean value) {
	 ...
	 * {@code revealHorizontalRightPadding?: number; }<br>
	 */
	public IEditorOptions revealHorizontalRightPadding(@Nonnull Double value) {
	 ...
	 * {@code roundedSelection?: boolean; }<br>
	 */
	public IEditorOptions roundedSelection(@Nonnull Boolean value) {
	 ...
	 * {@code rulers?: number[]; }<br>
	 */
	public IEditorOptions rulers(@Nonnull List<Double> value) {
	 ...
	 * {@code scrollBeyondLastColumn?: number; }<br>
	 */
	public IEditorOptions scrollBeyondLastColumn(@Nonnull Double value) {
	 ...
	 * {@code scrollBeyondLastLine?: boolean; }<br>
	 */
	public IEditorOptions scrollBeyondLastLine(@Nonnull Boolean value) {
	 ...
	 * {@code scrollbar?: IEditorScrollbarOptions; }<br>
	 */
	public IEditorOptions scrollbar(@Nonnull IEditorScrollbarOptions value) {
		set("scrollbar", value);
		return this;
	}
	 ...
	 * {@code selectOnLineNumbers?: boolean; }<br>
	 */
	public IEditorOptions selectOnLineNumbers(@Nonnull Boolean value) {
	 ...
	 * {@code selectionClipboard?: boolean; }<br>
	 */
	public IEditorOptions selectionClipboard(@Nonnull Boolean value) {
	 ...
	 * {@code selectionHighlight?: boolean; }<br>
	 */
	public IEditorOptions selectionHighlight(@Nonnull Boolean value) {
	 ...
	 * {@code showUnused?: boolean; }<br>
	 */
	public IEditorOptions showUnused(@Nonnull Boolean value) {
	 ...
	 * {@code smoothScrolling?: boolean; }<br>
	 */
	public IEditorOptions smoothScrolling(@Nonnull Boolean value) {
	 ...
	 * {@code stopRenderingLineAfter?: number; }<br>
	 */
	public IEditorOptions stopRenderingLineAfter(@Nonnull Double value) {
	 ...
	 * {@code suggest?: ISuggestOptions; }<br>
	 */
	public IEditorOptions suggest(@Nonnull ISuggestOptions value) {
		set("suggest", value);
		return this;
	}
	 ...
	 * {@code suggestFontSize?: number; }<br>
	 */
	public IEditorOptions suggestFontSize(@Nonnull Double value) {
	 ...
	 * {@code suggestLineHeight?: number; }<br>
	 */
	public IEditorOptions suggestLineHeight(@Nonnull Double value) {
	 ...
	 * {@code suggestOnTriggerCharacters?: boolean; }<br>
	 */
	public IEditorOptions suggestOnTriggerCharacters(@Nonnull Boolean value) {
	 ...
	 * {@code useTabStops?: boolean; }<br>
	 */
	public IEditorOptions useTabStops(@Nonnull Boolean value) {
	 ...
	 * {@code wordSeparators?: string; }<br>
	 */
	public IEditorOptions wordSeparators(@Nonnull String value) {
	 ...
	 * {@code wordWrapBreakAfterCharacters?: string; }<br>
	 */
	public IEditorOptions wordWrapBreakAfterCharacters(@Nonnull String value) {
	 ...
	 * {@code wordWrapBreakBeforeCharacters?: string; }<br>
	 */
	public IEditorOptions wordWrapBreakBeforeCharacters(@Nonnull String value) {
	 ...
	 * {@code wordWrapColumn?: number; }<br>
	 */
	public IEditorOptions wordWrapColumn(@Nonnull Double value) {
	 ...
	 * {@code wordWrapMinified?: boolean; }<br>
	 */
	public IEditorOptions wordWrapMinified(@Nonnull Boolean value) {
